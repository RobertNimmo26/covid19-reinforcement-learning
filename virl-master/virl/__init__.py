...
class Epidemic(Agent):
	...
	def __init__(self, stochastic=False, noisy=False, problem_id=0):
		...
		self.beta_bounds = [0.15, 0.60] # default infectivity
		self.problems = [0.53, 0.22, 0.47, 0.34, 0.32, 0.41, 0.26, 0.43, 0.57, 0.18]
		self.N = 1e8 # population size
		self.I0= 1e4# initial infectious and recovereds
		self.noise_level = 0.25 # weighted average of noisy observation and true state
